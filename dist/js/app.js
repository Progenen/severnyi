...
*/
        ...
        window.addEventListener("load", function(e) {
            ...
            const apartmentPlaneSliders = document.querySelectorAll(".apartment-planes__slider");
            apartmentPlaneSliders.forEach(sliderContainer => {
                const sliderInner = sliderContainer.querySelector(".apartment-planes__slider-inner");
                const prevBtn = sliderContainer.querySelector(".slider-controls__arrow-prev");
                const nextBtn = sliderContainer.querySelector(".slider-controls__arrow-next");
            ...
            tabButtons.forEach(button => {
                button.addEventListener("click", () => {
                    ...
                    sliders.forEach(slider => {
                        if (slider.getAttribute("data-tab-plane") === tabIndex) slider.classList.add("apartment-planes__slider--active"); else slider.classList.remove("apartment-planes__slider--active");
                    });
