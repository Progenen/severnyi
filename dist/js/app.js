(() => {
    ...
    window.addEventListener("load", function(e) {
        const textImgSliderText = new Swiper(".text-img-slider__text", {
            slidesPerView: 1,
            pagination: {
                el: document.querySelector(".text-img-slider__left .slider-controls__pagination"),
                clickable: true,
                type: "fraction",
            ...
            navigation: {
                nextEl: document.querySelector(".text-img-slider__left .slider-controls__arrow-next"),
                prevEl: document.querySelector(".text-img-slider__left .slider-controls__arrow-prev")
            },
            effect: "fade",
            fadeEffect: {
                crossFade: true
...
*/    var Observer_gsap, Observer_coreInitted, Observer_win, Observer_doc, _docEl, _body, _isTouch, _pointerType, ScrollTrigger, _root, _normalizer, _eventTypes, Observer_context, _getGSAP = function _getGSAP() {
    ...
    Observer_Observer.version = "3.14.2";
